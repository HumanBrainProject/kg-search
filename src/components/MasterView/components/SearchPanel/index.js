        ...
        return ( 
            <div className={this.state.className} style={this.state.style}>
                <TopBar>
                    ...
                    <button className="kgs-sidebar__button" onClick={onSidePanelToggle} title="toggle faceted search">
                        <i className="fa fa-angle-double-down kgs-sidebar__button-icon"></i>
                    </button>
                </TopBar>
            </div>
        );
