...
test('Carrousel component renders initially', () => {
    const component = renderer.create(
        <Carrousel className="className" show={true} value="a value" data={[{label: "a label", value: "a value"},{label: "another label", value: "another value"}]} onPrevious={() => {}} onClose={() => {}} itemComponent={() => null} navigationComponent={() => null} />
    );
...
test('Carrousel test show false"', () => {
    const component = renderer.create(
        <Carrousel className="className" show={false} value="a value" data={[{label: "a label", value: "a value"},{label: "another label", value: "another value"}]} onPrevious={() => {}} onClose={() => {}} itemComponent={() => null} navigationComponent={() => null} />
    );
...
test('Carrousel test navigation buttons', () => {
    ...
    const component = mount(
        <Carrousel className="className" show={true} value="a value" data={[{label: "a label", value: "a value"},{label: "another label", value: "another value"}]} onPrevious={previousFn} onClose={closeFn} itemComponent={() => null} navigationComponent={() => null} />
    );
