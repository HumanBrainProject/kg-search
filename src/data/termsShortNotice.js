...
Citation requirements are outlined [here](https://kg.ebrains.eu/search/search-terms-of-use#citations).

Acknowledgement requirements are outlined [here](https://kg.ebrains.eu/search/search-terms-of-use#acknowledgements).

These outlines are based on the authoritative Terms and Conditions are found [here](https://kg.ebrains.eu/search/search-terms-of-use).
