...
trait EditorBookmarkServiceInterface {
  ...
  def updateBookmarkList(bookmarkList: BookmarkList, bookmarkListPath: NexusPath, bookmarkListId: String, userFolderId:String, token: String): Future[Either[WSResponse, BookmarkList]]
