...
export const FileFormatFilter = connect(
  state => ({
    ...
    isFileFiltersInitialized: state.files.isFileFormatsInitialized,
    isFilesLoading: state.files.isFilesLoading,
    isFileFiltersLoading: state.files.isFileFormatsLoading,
    filesError: state.files.filesError,
    fileFiltersError: state.files.fileFiltersError,
    fileFilter: state.files.fileFormat
  }),
  (dispatch, props) => ({
