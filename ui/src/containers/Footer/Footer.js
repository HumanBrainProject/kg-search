  ...
  <footer className="site-footer">
    ...
    <div className="footer__end">
      ...
      <ul className="footer__social">
        ...
        <li>
          <a href="https://twitter.com/ebrains_eu" target="_blank" rel="noopener noreferrer">
        ...
        {/* <li>
            <a href="https://www.youtube.com/user/TheHumanBrainProject" target="_blank" rel="noopener">
        ...
        <li>
          <a href="https://www.instagram.com/ebrains_eu/" target="_blank" rel="noopener noreferrer">
        ...
        {/* <li>
          <a href="https://github.com/HumanBrainProject/" target="_blank" rel="noopener">
