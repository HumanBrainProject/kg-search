    ...
    <footer className="site-footer">
      <div className="footer__header">
        <div className="footer__primary">
          ...
          {profile !== 'ebrains' &&
              <span className="service-at"><a href={profiles[profile]["home"]} aria-label="Homepage" title="Homepage"
                                              className="logo nuxt-link-exact-active nuxt-link-active"> <img
                  src={`/static/img/${theme === 'dark' ? profiles[profile]["logo_dark"] : profiles[profile]["logo"]}`}
                  height="100"/></a> @ </span>}
          <a href="https://ebrains.eu" aria-label="Ebrains homepage" title="Ebrains homepage"
             className="logo nuxt-link-exact-active nuxt-link-active"><img
      ...
      <div className="footer__content">
        <div className="footer__secondary">
          ...
          <div className="powered-by">
            <a className="hbp-logo" href="https://www.humanbrainproject.eu/" title="Human Brain Project" target="_blank"
               rel="noopener noreferrer">
              <img src="/static/img/hbp.svg" alt="Human Brain Project"/>
            </a>
            <a className="eu-logo" href="https://ec.europa.eu/programmes/horizon2020/en/h2020-section/fet-flagships"
               title="Cofunded by EU" target="_blank" rel="noopener noreferrer">
      ...
      <div className="footer__end">
        ...
        <ul className="footer__social">
          <li>
            <a href="https://www.facebook.com/Ebrains_eu-112559066821827" target="_blank" rel="noopener noreferrer"
               title="Facebook">
          ...
          <li>
            <a href="https://twitter.com/ebrains_eu" target="_blank" rel="noopener noreferrer" title="Twitter">
              <svg className="sprite-icons" xmlns="http://www.w3.org/2000/svg" id="i-twitter" viewBox="0 0 40 40"
                   fill="none">
                <path
          ...
          <li>
            <a href="https://www.instagram.com/ebrains_eu/" target="_blank" rel="noopener noreferrer" title="Instagram">
              <svg className="sprite-icons" xmlns="http://www.w3.org/2000/svg" id="i-instagram" viewBox="0 0 40 40"
                   fill="none">
                <path d="M25 10H15a5 5 0 00-5 5v10a5 5 0 005 5h10a5 5 0 005-5V15a5 5 0 00-5-5z" stroke="currentColor"
                      strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M24 19.37a4 4 0 11-7.914 1.173A4 4 0 0124 19.37zM25.5 14.5h.01" stroke="currentColor"
                      strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </a>
          </li>
          ...
          <li>
            <a href="https://www.linkedin.com/company/ebrains-eu" target="_blank" rel="noopener noreferrer"
               title="Linkedin">
              <svg className="sprite-icons" xmlns="http://www.w3.org/2000/svg" id="i-linkedin" viewBox="0 0 40 40"
                   fill="none">
                <path
                    d="M24 16a6 6 0 016 6v7h-4v-7a2 2 0 00-4 0v7h-4v-7a6 6 0 016-6v0zM14 17h-4v12h4V17zM12 14a2 2 0 100-4 2 2 0 000 4z"
                    stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </a>
          </li>
      ...
      {profiles[profile]["copyrightAddition"] && <p className="footer__copyright_addition">{profiles[profile]["copyrightAddition"]}</p>}
    </footer>
);
