...
import { loadSearchSettingsSuccess, loadSearchSettingsFailure } from "../actions/actions.settings";
...
describe("settings reducer", () => {
  ...
  describe("load settings failure", () => {
    it("should set ready to false", () => {
      ...
      const action = loadSearchSettingsFailure("error");
      const newState = settingsReducer(state, action);
