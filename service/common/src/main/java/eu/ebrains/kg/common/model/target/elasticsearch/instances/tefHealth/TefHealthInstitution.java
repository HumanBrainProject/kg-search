...
@Getter
@Setter
@MetaInfo(name = "TEF Institution", searchable = true)
public class TefHealthInstitution implements TargetInstance {
    ...
    @ElasticSearchInfo(type = "keyword")
    private Value<String> type = new Value<>("TEF Institution");
