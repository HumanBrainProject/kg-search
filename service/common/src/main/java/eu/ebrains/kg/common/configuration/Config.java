...
public class Config {
    @Bean
    public OpenAPI customOpenAPI(@Value("${spring.security.oauth2.client.provider.keycloak.issuer-uri}") String issuerUri, @Value("${eu.ebrains.kg.commit}") String commit) {
