...
package eu.ebrains.kg.common.model.target.elasticsearch.instances.tefHealth;
...
@Getter
@Setter
@MetaInfo(name = "TEF Service", defaultSelection = true, searchable = true)
public class TefHealthService implements TargetInstance {
    ...
    @ElasticSearchInfo(type = "keyword")
    private Value<String> type = new Value<>("TEF Service");
    ...
    private Value<String> serviceCategory;
