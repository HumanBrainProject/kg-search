...
import eu.ebrains.kg.common.controller.translators.kgv3.tefHealth.TefHealthCountryV3Translator;
import eu.ebrains.kg.common.controller.translators.kgv3.tefHealth.TefHealthInstitutionV3Translator;
import eu.ebrains.kg.common.controller.translators.kgv3.tefHealth.TefHealthServiceV3Translator;
...
public class TranslatorModel<v3Input extends SourceInstanceV3, Output extends TargetInstance> {
    ...
    public static final List<TranslatorModel<?, ?>> MODELS = Arrays.asList(
            new TranslatorModel<>(TefHealthService.class, new TefHealthServiceV3Translator(), false, 1000, true),
            new TranslatorModel<>(TefHealthInstitution.class, new TefHealthInstitutionV3Translator(), false, 1000, true),
            new TranslatorModel<>(TefHealthCountry.class, new TefHealthCountryV3Translator(), false, 1000, true)
