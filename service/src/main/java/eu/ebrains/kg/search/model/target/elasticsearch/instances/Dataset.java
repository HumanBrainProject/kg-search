...
public class Dataset {
    ...
    public void setExternalDatalink(String externalDatalink) {
        setExternalDatalink(externalDatalink != null? new Value<>(externalDatalink):null);
    }
    ...
    public List<ExternalReference> getRegion() {
        return region;
    }
    ...
    public void setPreparation(List<String> preparation) {
        this.preparation = preparation != null ? preparation.stream().map(Value::new).collect(Collectors.toList()):null;
    }
