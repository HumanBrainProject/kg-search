...
public class Sample {
    ...
    private List<Value<String>> region;

    @FieldInfo(label = "Viewer")
    private List<ExternalReference> viewer;
    ...
    public void setParcellationAtlas(List<Value<String>> parcellationAtlas) { this.parcellationAtlas = parcellationAtlas; }

    public List<Value<String>> getRegion() { return region; }

    public void setRegion(List<Value<String>> region) { this.region = region; }

    public List<ExternalReference> getViewer() { return viewer; }

    public void setViewer(List<ExternalReference> viewer) { this.viewer = viewer; }

    public List<Value<String>> getMethods() { return methods; }

    public void setMethods(List<Value<String>> methods) { this.methods = methods; }
    ...
    public void setSubject(List<Children<Subject>> subject) { this.subject = subject; }
    ...
    public static class Subject {
        ...
        private InternalReference subjectName;
        ...
        public InternalReference getSubjectName() { return subjectName; }

        public void setSubjectName(InternalReference subjectName) { this.subjectName = subjectName; }
