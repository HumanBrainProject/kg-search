...
public class Indexing {
    ...
    public String refreshDOICitation(@RequestParam("doi") String doi, @RequestParam("style") String style){
        return this.doiCitationFormatter.refreshDOICitation(doi, style);
    }
