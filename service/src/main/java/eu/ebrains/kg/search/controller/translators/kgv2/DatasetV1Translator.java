...
public class DatasetV1Translator extends TranslatorV2<DatasetV1, DatasetVersion, DatasetV1Translator.Result> {
    ...
    public DatasetVersion translate(DatasetV1 datasetV1, DataStage dataStage, boolean liveMode, DOICitationFormatter doiCitationFormatter) {
        ...
        if (datasetV1.isUseHDG()) {
            d.setUseHDG(DatasetVersion.createHDGMessage(datasetV1.getIdentifier(), false));
            d.setEmbargo(DatasetVersion.createHDGMessage(datasetV1.getIdentifier(), true));
