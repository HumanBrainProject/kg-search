...
public class DatasetVersion implements TargetInstance {
    ...
    public Value<String> getDataAccessibility() {
        return dataAccessibility;
    }

    public void setDataAccessibility(String dataAccessibility) {
        setEmbargoForFilter(StringUtils.isBlank(dataAccessibility) ? null : new Value<>(dataAccessibility));
    }

    public void setEmbargoForFilter(Value<String> embargoForFilter) {
        this.dataAccessibility = embargoForFilter;
    }
    ...
    public void setKeywords(List<String> keywords) {
        this.keywords = keywords == null ? null : keywords.stream().map(Value::new).collect(Collectors.toList());
    }
