...
public class DatasetVersion implements TargetInstance {
    ...
    @FieldInfo(label = "Data-descriptor", isButton = true, icon="sticky-note", isDirectDownload=true)
    ...
    private List<TargetInternalReference> component;
    ...
    public TargetExternalReference getZip() {
        return zip;
    }

    public void setZip(TargetExternalReference zip) {
        this.zip = zip;
    }
    ...
    public void setDataDescriptor(TargetExternalReference dataDescriptor) {
    ...
    public void setAtlas(List<String> atlas) {
        this.atlas = atlas == null ? null : atlas.stream().map(Value::new).collect(Collectors.toList());
    }
    ...
    public void setModalityForFilter(List<String> modalityForFilter) {
        this.modalityForFilter = modalityForFilter == null ? null : modalityForFilter.stream().map(Value::new).collect(Collectors.toList());
    }
    ...
    public void setPreparation(List<String> preparation) {
        this.preparation = preparation == null ? null : preparation.stream().map(Value::new).collect(Collectors.toList());
    }
    ...
    public void setProtocol(List<String> protocol) {
        this.protocol = protocol == null ? null : protocol.stream().map(Value::new).collect(Collectors.toList());
    }
    ...
    public TargetInternalReference getDataset() {
        return dataset;
    }
