...
public class DatasetVersion implements TargetInstance, VersionedInstance{
    ...
    @FieldInfo(label = "Studied brain region", layout = FieldInfo.Layout.SUMMARY)
    ...
    //TODO This can be achieved via the serviceLink (indirectly connected by the files of the dataset) -> this is not filled with data yet
