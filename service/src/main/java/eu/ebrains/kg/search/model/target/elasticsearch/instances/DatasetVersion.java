...
public class DatasetVersion implements TargetInstance, VersionedInstance{
    ...
    @FieldInfo(label = "Subjects", layout = "Subjects", hint = "List of experimental subjects that are a part of this dataset.", isTable = true)
    private List<Children<Subject>> subjects;

    @FieldInfo(label = "Subjects", layout = "Subjects", hint = "List of experimental subjects that are a part of this dataset.", isTable = true)
    private List<Children<NewSubject>> subjectsNew;
