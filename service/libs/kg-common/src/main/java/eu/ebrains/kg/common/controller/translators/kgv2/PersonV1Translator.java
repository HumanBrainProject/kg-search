...
import eu.ebrains.kg.common.model.source.openMINDSv1.PersonV1;
...
public class PersonV1Translator extends TranslatorV2<PersonV1, Contributor, PersonV1Translator.Result> {
    ...
    @Override
    public Contributor translate(PersonV1 person, DataStage dataStage, boolean liveMode, TranslatorUtils translatorUtils) throws TranslationException {
