...
public @interface MetaInfo {
     ...
     * {@link  eu.ebrains.kg.common.model.target.elasticsearch.instances.DatasetVersion} only the latest version is searchable,
     * the annotation for the {@link eu.ebrains.kg.common.model.target.elasticsearch.instances.DatasetVersion} type is still searchable=true though)
     *
