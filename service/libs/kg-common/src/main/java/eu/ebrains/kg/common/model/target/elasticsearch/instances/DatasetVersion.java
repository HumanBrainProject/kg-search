...
public class DatasetVersion implements TargetInstance, VersionedInstance, HasCitation, HasPreviews, HasBadges, HasTrendingInformation{
     ...
     */
    @Deprecated(forRemoval = true)
    @FieldInfo(label = "Brain atlas", layout = "summary", useForSuggestion = true)
     ...
     */
    @Deprecated(forRemoval = true)
    @FieldInfo(label = "Modality", type = FieldInfo.Type.TEXT, visible = false, facet = FieldInfo.Facet.LIST, useForSuggestion = true)
     ...
     */
    @Deprecated(forRemoval = true)
    @FieldInfo(label = "Modality", type = FieldInfo.Type.TEXT, useForSuggestion = true)
